...
public class UsersService {
     ...
     */
    public Page<Users> find(PageQuery paging) {
     ...
     * @return 结果
     */
    public com.bwton.lang.Page<Users> pages1(String cname, PageQuery paging) {
        UserVo userVo = new UserVo();
        userVo.setCname(cname);
        userVo.setPageNo(paging.getPageNo());
        userVo.setPageSize(paging.getPageSize());
        return mapper.pages1(userVo);
    }
