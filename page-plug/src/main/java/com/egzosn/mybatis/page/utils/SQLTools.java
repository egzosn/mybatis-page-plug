...
public class SQLTools {
	 ...
	 * @return 转化后的sql
	 */
	public static String getCount(final String sql, String countField) {

		StringBuilder countSql = new StringBuilder()
				.append("SELECT  COUNT(").append(isEmpty(countField) ? "*" : countField).append(") FROM (")
				.append(sql).append(')');
		return countSql.toString();
	}

	private static boolean isEmpty(String countField) {
		return null == countField || "".equals(countField);
